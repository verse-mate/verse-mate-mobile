/**
 * The React implementation of markdown rendering, plus the app's shared parser.
 *
 * Split out from `Markdown` so the native renderer can use this as its FALLBACK without an import
 * cycle: this file is a leaf, `NativeMarkdown` imports it, and `Markdown` chooses between them.
 *
...
export type MarkdownProps = ComponentProps<typeof MarkdownDisplay>;

export function ReactMarkdown(props: MarkdownProps) {
