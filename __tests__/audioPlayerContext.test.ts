 ...
 */
import { audioReducer, type AudioTrack } from "../contexts/AudioPlayerContext";
...
describe("mobile audioReducer", () => {
  test("LOAD moves to 'loading' and never to 'playing' (br-audio-005)", () => {
    const next = audioReducer(
      { currentTrack: null, playbackState: "idle", elapsedSeconds: 0, durationSeconds: 0, speed: 1, error: null, dockVisible: false, fullScreenOpen: false },
